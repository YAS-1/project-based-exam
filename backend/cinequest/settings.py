...
MIDDLEWARE = [
    ...
    "corsheaders.middleware.CorsMiddleware", # Added the missing corsheaders.middleware.CorsMiddleware to the MIDDLEWARE array to resolve production CORS blocking errors from the Next.js frontend.
